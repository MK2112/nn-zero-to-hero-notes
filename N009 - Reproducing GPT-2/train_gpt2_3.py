...
# batches and context sizes are chosen to be large here
# I intentionally only run one epoch to inform about processing time and tok/sec.
# This implementation does not include algorithmic optimizations.
...
for i in range(50):
    ...
    t1 = time.time()
    dt = (t1 - t0) * 1000 # millisecond time difference
