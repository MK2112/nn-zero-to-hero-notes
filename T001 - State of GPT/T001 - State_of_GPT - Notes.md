...
GPT-4 can actually reflect on past answers, apologizing for prior, unfavorably sampled responses.<br>Ideally, though, we shouldn't need the model to apologize and instead explore the sampling space, coming up with a best-aligned, best quality-measured answer.
